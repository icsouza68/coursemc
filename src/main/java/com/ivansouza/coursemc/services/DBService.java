...
public class DBService {
	...
	public void InstantiateDatabase() throws ParseException {
		...
		Estado est2 = new Estado(null, "Saão Paulo");
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "icsouza@yahoo.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("23764332", "12345678"));

		Cliente cli2 = new Cliente(null, "Ana Cunha", "icsouza68@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("456"));
		cli2.addPerfil(PerfilCliente.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("32119876", "3535311234"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220634", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 3B", "Centro", "38772235", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "38700235", cli2, c3);
